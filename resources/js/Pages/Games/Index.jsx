                                ...
                                <table className="w-full text-left text-sm text-gray-500">
                                    <thead className="bg-gray-50 text-xs uppercase text-gray-700">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3">URL Base</th>
                                    ...
                                    <tbody>
                                        {games.map((game) => (
                                            <tr key={game.id} className="border-b bg-white hover:bg-gray-50">
                                                <td className="px-6 py-4 font-medium text-gray-900">
                                                    {game.title}
                                                </td>
                                                <td className="px-6 py-4">/{game.url}</td>
                                                <td className="px-6 py-4">
                                                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${game.is_published ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                                                        {game.is_published ? 'Sí' : 'No'}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">{game.user?.name}</td>
