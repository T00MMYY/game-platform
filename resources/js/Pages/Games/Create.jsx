                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 border-b border-gray-200">
                            ...
                            <form onSubmit={submit} className="max-w-xl">
                                ...
                                <div className="mt-4">
                                    <InputLabel htmlFor="url" value="Ruta del Juego / URL (*)" />
                                    <TextInput
                                        id="url"
                                        type="text"
                                        name="url"
                                        value={data.url}
                                        className="mt-1 block w-full"
                                        placeholder="ejemplo-juego"
                                        onChange={(e) => setData('url', e.target.value)}
                                    />
                                    <p className="text-sm text-gray-500 mt-1">
                                        URL accesible amigable (sin espacios).
                                    </p>
                                ...
                                <div className="mt-4 block">
                                    <label className="flex items-center">
                                        ...
                                        />
                                        <span className="ms-2 text-sm text-gray-600">Publicado y visible para todos los jugadores.</span>
                                    </label>
                                    <InputError message={errors.is_published} className="mt-2" />
                                </div>

                                <div className="mt-4">
                                    <InputLabel htmlFor="thumbnail" value="Imagen (Opcional)" />
                                    <input
                                        type="file"
                                        id="thumbnail"
                                        name="thumbnail"
